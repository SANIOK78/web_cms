...
// Vérif s'il y un transfert du paramétre "modif_userId" a partir de URL
...
if(isset($_GET['modif_userId']) && isset($_SESSION['id_user']) && 
    ...
    // Récup resultat sous forme d'un tableau, line par line
    ...
    $photoProfil = $infosUser['photo_user'];   //nom de la photo
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <?php 
                                                    echo "<img width=30 height=30 class='media-object' 
